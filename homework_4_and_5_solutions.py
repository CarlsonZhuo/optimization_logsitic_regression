...
#     initbeta=np.random.rand(train.Z.shape[0],train.Z.shape[1])*10
    ...
    beta_gd,loss_gd,reg_gd,te_error_gd,elapsed_time_gd=descent(gd, func_logreg_multiclass, grad_logreg_multiclass,None,train, test, params,constantstep)
    #agd
    params.stepsize=stepsize
    beta_agd,loss_agd,reg_agd,te_error_agd,elapsed_time_agd=descent(agd, func_logreg_multiclass, grad_logreg_multiclass,None,train, test, params,constantstep)
    #magd
    params.stepsize=stepsize
    beta_magd,loss_magd,reg_magd,te_error_magd,elapsed_time_magd=descent(magd, func_logreg_multiclass, grad_logreg_multiclass,None,train, test, params,constantstep)
...
if __name__ == "__main__":
#    p45(T=int(50),reg=1e-3,stepsize=1e-1)
#    p45(T=int(50),reg=1e-3,stepsize=1e-2)
    p45(T=int(100),reg=1e-3,stepsize=1e-2)
